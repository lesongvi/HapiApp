...
import com.hapi.hapiservice.models.bot.Bot;
...
public class ChatBotController extends BaseBot {
    ...
    private stringHelper definedStr;
    ...
    public final ResponseEntity setupWebhookVerification(@RequestParam("hub.mode") String mode,
        ...
        System.out.println("Something just requested");
    ...
    @Controller(events = {EventType.MESSAGE, EventType.POSTBACK}, pattern = "!(?i)(^([0-9]*|Đăng nhập|bắt đầu|chào|bắt đầu lại|Xem thời khóa biểu|Đăng xuất|Cài đặt)$)")
    public void defaultReply(Event event) throws BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, InvalidKeyException, MalformedURLException, JsonProcessingException {
        String fid = event.getSender().getId();
        ScheduleBot schedulebot = new ScheduleBot(
                fid,
                this.chatbotstudentRepository,
    ...
    @Controller(events = {EventType.MESSAGE, EventType.POSTBACK}, pattern = "^(?i)(Cài đặt)$", next = "configCredentialsStep2")
    public void configMyCredentials(Event event) throws BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, InvalidKeyException, IOException, InterruptedException {
    ...
    @Controller(events = {EventType.MESSAGE, EventType.POSTBACK, EventType.QUICK_REPLY}, pattern = "^(?i)(Đăng xuất)$", next = "configCredentialsStep2")
    public void configCredentialsStep2(Event event) throws BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, InvalidKeyException, IOException, InterruptedException {
        String fid = event.getSender().getId();
        ScheduleBot schedulebot = new ScheduleBot(
                fid,
                this.chatbotstudentRepository,
    ...
    public void viewPointStep2(Event event) {
        String fid = event.getSender().getId();
        ScheduleBot schedulebot = new ScheduleBot(
                fid,
                this.chatbotstudentRepository,
    ...
    public void askForWeek(Event event) throws BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, InvalidKeyException, MalformedURLException {
        String fid = event.getSender().getId();
        ScheduleBot schedulebot = new ScheduleBot(
                fid,
                this.chatbotstudentRepository,
    ...
    public void showMeMySchedule(Event event) throws BadPaddingException, NoSuchAlgorithmException, NoSuchPaddingException, IllegalBlockSizeException, InvalidKeyException, IOException, InterruptedException {
        String fid = event.getSender().getId();
        ScheduleBot schedulebot = new ScheduleBot(
                fid,
                this.chatbotstudentRepository,
