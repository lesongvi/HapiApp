...
public class ScheduleController {
    ...
    @RequestMapping(value = {routeHelper.getSemester}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = {routeHelper.getWeek}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @RequestMapping(value = {routeHelper.getSchedule}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
