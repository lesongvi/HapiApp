...
public class ScheduleController {
    ...
    @RequestMapping(value = {routeHelper.getExamSche}, method = RequestMethod.POST, produces = MediaType.APPLICATION_JSON_VALUE)
    public String getSemesterPoint (@RequestParam(value = "token", defaultValue = "") String token) throws IOException, IllegalBlockSizeException, NoSuchPaddingException, BadPaddingException, NoSuchAlgorithmException, InvalidKeyException, ParseException {
        this.studentBasicTest = new browserHelper(token, this.studentRepository, this.studentService);

        return this.studentBasicTest.getExamScheList();
    }
