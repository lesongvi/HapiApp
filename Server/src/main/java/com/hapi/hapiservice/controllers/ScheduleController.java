...
public class ScheduleController {
    ...
    @RequestMapping(value = {routeHelper.studentAuth}, method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    ...
    @GetMapping({routeHelper.getWeek})
    ...
    @GetMapping({routeHelper.getSchedule})
